...
export function handlePrismaError(error: unknown): AppError {
  ...
  if (error instanceof Error) {
    ...
    if (
      appError.message.includes("권한이 없") ||
 ...
 */
export function validationError(errors: Record<string, string>): AppError {
