...
exports.checkFavorite = exports.removeFavorite = exports.addFavorite = exports.deleteArticle = exports.updateArticle = exports.getArticleById = exports.getArticles = exports.createArticle = void 0;
...
const createArticle = async (title, content, userId) => {
    ...
    return (0, formatters_1.createArticleResponseDto)(article, user, false);
};
...
const getArticles = async (page, limit, keyword, sortBy = "latest", userId = null) => {
    ...
    // 검색 조건 생성
    const where = (0, prismaHelpers_1.createSearchCondition)(keyword, [
        "title",
        "content",
    ]);
    // 정렬 조건 생성
    const orderBy = sortBy === "likes"
        ...
        : { createdAt: "desc" };
    // 페이지네이션 파라미터 생성
    const { skip, take } = (0, prismaHelpers_1.createPaginationParams)(pageNum, limitNum);
    // 게시글 조회
    ...
    if (userId) {
        ...
        formattedArticles = (0, formatters_1.attachFavoriteStatus)(formattedArticles, favoriteArticleIds);
    }
...
const getArticleById = async (id, userId = null) => {
    ...
    return (0, formatters_1.createArticleResponseDto)(article, user, isFavorite);
};
...
const updateArticle = async (id, title, content, userId = null) => {
    ...
    if (userId !== null) {
        (0, authHelpers_1.verifyPermission)(article, userId, "userId", "게시글");
    }
    else {
        // userId가 null인 경우 리소스 존재 여부만 확인
        (0, authHelpers_1.checkResourceExists)(article, "게시글");
    }
    ...
    return (0, formatters_1.createArticleResponseDto)(updatedArticle, user, isFavorite);
};
...
const addFavorite = async (articleId, userId) => {
    ...
    return await prisma.$transaction(async (tx) => {
        ...
        return (0, formatters_1.createArticleResponseDto)(updatedArticle, user, true);
    });
};
...
const removeFavorite = async (articleId, userId) => {
    ...
    return await prisma.$transaction(async (tx) => {
        ...
        return (0, formatters_1.createArticleResponseDto)(updatedArticle, user, false);
    });
};
