...
import { createProductResponseDto, attachFavoriteStatus, } from "../../utils/formatters.js";
...
const getProducts = async (page = 1, pageSize = 10, orderBy = "recent", keyword, userId = null) => {
    ...
    if (userId) {
        ...
        productsWithDetails = attachFavoriteStatus(productsWithDetails, favoriteProductIds);
    }
